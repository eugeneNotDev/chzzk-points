...
- **칭호** — 최고 보유 포인트 기준으로 자동으로 붙는 등급 칭호(브론즈~다이아몬드)는 이름 색으로 보이고, 상점에서 산 칭호나 관리자가 직접 준 칭호는 색을 입힌 배지로 보임. 마이페이지에서 골라서 장착함
...
- **관리자 페이지** — 유저 검색, 포인트 지급/차감(일괄 가능, 실행취소 가능), 칭호 직접 지급/회수, 밴, 전체 포인트 로그, 상점 사용 내역 처리
